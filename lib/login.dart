...
// void main() => runApp(MaterialApp(debugShowCheckedModeBanner: false, home: LoginPageWidget()));
...
//       context,
//       MaterialPageRoute(builder: (context) => WelcomeUserWidget(user, _googleSignIn)),
//     );
